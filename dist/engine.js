...
import { QUALITY, STEP } from './params.js';
export class Engine {
    constructor(canvas) {
        this.width = 1;
        this.height = 1;
        ...
        this.blurA = tex();
        this.blurB = tex();
        this.blurAFBO = gl.createFramebuffer();
        this.blurBFBO = gl.createFramebuffer();
    }
    /* ---------------- shader helpers ---------------- */
    compile(type, src) {
        const gl = this.gl;
    ...
    render(cam, t, dt) {
        ...
        this.set3(U.uCamPos, cam.pos);
        this.set3(U.uCamRight, cam.right);
        this.set3(U.uCamUp, cam.up);
        this.set3(U.uCamFwd, cam.fwd);
